  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          {" "}
          <stop className="ccompli2" stopColor="#64C2DB"></stop>{" "}
          <stop offset="0.510417" className="ccompli1" stopColor="#7476ED"></stop>{" "}
          <stop offset="1" className="ccustom" stopColor="#E56F8C"></stop>{" "}
        </linearGradient>{" "}
      </defs>{" "}
    </svg>
    </div>
